...
public class WriteClus implements IDataWrite {
			...
			for (int n = 0, lenSnap = snap.size(); n < lenSnap; n++) {
				...
				for (int m = 0, lenCluster = cluster.size(); m < lenCluster; m++) {
					br.write((n + 1) + "," + String.valueOf(cluster.get(m).getVideoID()) + ","
							+ String.valueOf(cluster.get(m).getLatitude()) + ","
							+ String.valueOf(cluster.get(m).getLongitude()) + ","
							...
							+ String.valueOf(cluster.get(m).getPolygon().getP1().getX() + " "
									+ cluster.get(m).getPolygon().getP1().getY())
							+ " "
							+ String.valueOf(cluster.get(m).getPolygon().getP2().getX() + " "
									+ cluster.get(m).getPolygon().getP2().getY())
							+ " "
							+ String.valueOf(cluster.get(m).getPolygon().getP3().getX() + " "
									+ cluster.get(m).getPolygon().getP3().getY())
							+ " "
							+ String.valueOf(cluster.get(m).getPolygon().getP4().getX() + " "
									+ cluster.get(m).getPolygon().getP4().getY())
							+ " "
							+ String.valueOf(cluster.get(m).getPolygon().getD().getX() + " "
									+ cluster.get(m).getPolygon().getD().getY())
							+ " " + String.valueOf(cluster.get(m).getPolygon().getLocation().getX() + " "
									+ cluster.get(m).getPolygon().getLocation().getY())
							+ ",");
					br.newLine();
					br.flush();
				}
